...
public class GUIView extends JPanel {
	...
	public GUIView(IGameFactory factory) {
		...
		this.gameView.setBackground(new Color(135, 206, 235));/**cambio del color de fondo a celeste*/
		...
		this.startGameButton = new JButton("Empezar");/**modificacion en el nombre del boton*/
